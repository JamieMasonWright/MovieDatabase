...
data class MovieDTO(
    ...
    @SerializedName("backdrop_path") @ColumnInfo(
        name = "backdrop_path",
        defaultValue = "N/A"
    ...
    @SerializedName("original_language") @ColumnInfo(
        name = "original_language",
        defaultValue = "N/A"
    ) val originalLanguage: String,
    @SerializedName("original_title") @ColumnInfo(
        name = "original_title",
        defaultValue = "N/A"
    ) val originalTitle: String,
    @SerializedName("overview") @ColumnInfo(
        name = "overview",
        defaultValue = "N/A"
    ) val overview: String,
    @SerializedName("popularity") @ColumnInfo(name = "popularity") val popularity: Float,
    @SerializedName("poster_path") @ColumnInfo(
        name = "poster_path",
        defaultValue = "N/A"
    ) val posterPath: String,
    @SerializedName("release_date") @ColumnInfo(
        name = "release_date",
        defaultValue = "N/A"
